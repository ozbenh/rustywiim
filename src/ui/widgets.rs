...
fn build_mini_top_bar() -> (Label, Button, GtkBox) {
    ...
    (mini_device_label, mini_restore_btn, mini_top_bar)
}
...
pub(super) fn build_mini_window() -> (MiniWidgets, gtk::Window) {
    ...
    let (mini_device_label, mini_restore_btn, mini_top_bar) = build_mini_top_bar();
